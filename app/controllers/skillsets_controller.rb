class SkillsetsController < ApplicationController
  ...
  private
    ...
    def skillset_params
      params.require(:skillset).permit(:client_id, :project_management, :scripting, :programming, :dbadmin, :ui_ux, :algorithms, :system_design, :analysis, :web_dev, :mobile_dev, :sysarchitecture, :ai, :game_programming)
    end
end
